        ...
        try {
          ...
          const completion = await dynamicOpenai.chat.completions.create({
            ...
            messages: [
              {
                role: 'system',
                content: `أنت مساعد ذكي احترافي لمنصة التوظيف الذكية. المطور: المهندس هشام المجمر. ساعد المستخدم في رحلته المهنية (وظائف، سير ذاتية، مقابلات). تحدث بالعربية بأسلوب ودود ومحفز.`
              },
