...
// فريق التطوير: م. هشام المجمر (مدير) • م. هيثم نجاد • م. محمد حنش • م. محمد مسرع • م. مكين الشلفي
class AIService {
  constructor() {
  ...
  async generateChatResponse(message, context) {
    ...
    if (lowerMessage.includes('مرحبا') || lowerMessage.includes('السلام') || lowerMessage.includes('hello') || lowerMessage.includes('أهلا')) {
      const greetings = [
        'مرحباً بك في منصة التوظيف الذكية! 🌟 أنا مساعدك الشخصي، كيف يمكنني مساعدتك اليوم؟',
...
👨‍💻 **المهندس هشام المجمر**
📞 الهاتف: 773988932
📧 البريد: hshamaljmr53@gemail.com
